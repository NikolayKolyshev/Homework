 ...
 str1 = '23 марта 2002 0.36 0.32 0.28 0.25'; % инициализация строки
 ...
 str2 = '23 2002 0.36 0.32 0.28 0.25'; % инициализация строки
 disp('////////////////////////'); % Визуальный разделитель
 disp(['Входная строка с числами str2 = ', str2]); % Вывод исходной строки
 str2 = strrep(str2, '23', 'Двадцать три'); % Замена числа 23
 str2 = strrep(str2, '2002', 'Две тысячи два'); % Замена числа 2002
 str2 = strrep(str2, '0.36', 'Тридцать шесть сотых'); % Замена числа 0.35
 str2 = strrep(str2, '0.32', 'Тридцать две сотые'); % Замена числа 0.32
 str2 = strrep(str2, '0.28', 'Двадцать восемь сотых'); % Замена числа 0.28
 str2 = strrep(str2, '0.25', 'Двадцать пять сотых'); % Замена числа 0.25
 % Вывод результата
 disp('При замене цифр на слова получилось следующее:');
 disp(str2);
 
 str3 = '23 марта 2002 0.36 0.32 0.28 0.25'; % инициализация строки
 disp('///////////////////////'); % визуальный разделитель
 ...
 sNumb1 = str2double(str3(1:p(1)-1)); % запись числа 23
 sNumb2 = str2double(str3(p(2):p(3)-1)); % запись числа 2002
 sNumb3 = str2double(str3(p(3):p(4)-1)); % запись числа 0.36 
 sNumb4 = str2double(str3(p(4):p(5)-1)); % запись числа 0.32
 sNumb5 = str2double(str3(p(5):p(6)-1)); % запись числа 0.28
 sNumb6 = str2double(str3(p(6):end)); % запись числа 23
 
 disp('Вывод массива с числами из исходной строки:');
 format short g; % изменение формата вывода для корректного отображения чисел
 masNumb = [sNumb1 sNumb2 sNumb3 sNumb4 sNumb5 sNumb6] % вывод рез-ов в массив
